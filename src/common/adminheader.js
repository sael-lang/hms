...
class Header extends React.Component {
    ...
    render(){
        return <nav className="navbar navbar-expand-lg navbar-light bg-light fixed-top border-bottom">
            <div className="container-fluid adminbelow">
                    ...
                    <ul className="navbar-nav ms-auto mt-2 mt-lg-0">
                        ...
                        <li className="nav-item dropdown notifications">
                            ...
                            <div className="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                <a className="dropdown-item" href="#!">fix docter section</a>
                                <a className="dropdown-item" href="#!">add staff</a>
                                <div className="dropdown-divider"></div>
                                <a className="dropdown-item" href="#!">remove docter</a>
                            </div>
                        </li>
                    </ul>
                </div>
